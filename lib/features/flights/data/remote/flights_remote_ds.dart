...
class FlightsRemoteDs with BaseRemoteDs {
  ...
  Future<List<FlightModel>> getUpdatedFlights() => execute(() async {
    final response = await api.get(
  ...
  Future<List<FlightModel>> searchFlights(String query) => execute(() async {
    final response = await api.get(
  ...
  Future<FlightModel> getFlightById(String id) => execute(() async {
  ...
  Future<void> trackFlight(String id) => execute(() async {
    final endpoint = ApiEndpoints.trackFlight.replaceAll(':id', id);
    await api.post(endpoint, body: {});
  });

  Future<void> untrackFlight(String id) => execute(() async {
