        ...
        child: Column(
          ...
          children: [
            Stack(
              children: [
                ClipRRect(
                  borderRadius: BorderRadius.vertical(top: Radius.circular(rr(18))),
                  child: CachedNetworkImage(
                    ...
                    placeholder: (_, __) => Container(
                      ...
                      child: Icon(Icons.storefront_outlined,
                          size: rr(40), color: AppColors.grey400),
                    ),
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        Icon(Icons.star_rounded, color: AppColors.white, size: rr(12)),
                        horizontalSpacing(3),
                        Text(
                  ...
                  Row(
                    children: [
                      Icon(Icons.location_on_outlined,
                          size: rr(12), color: colors.iconSecondary),
                      horizontalSpacing(2),
                      Expanded(
                        child: Text(
